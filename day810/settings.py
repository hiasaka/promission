"""
Django settings for rbacdemon project.
...
SECRET_KEY = '9@m_fqe)hh(e2#s^#vacd36nxm+st5dr91a%k*l6u%1&9@w&my'
...
WSGI_APPLICATION = 'day810.wsgi.application'
...
###2.session中保存权限信息的key
RBAC_PERMISSION_SESSION_KEY='rbac_permission_session_key'

###3.Http请求中传入的参数，根据其获取GET,POST,EDIT等检测用户是否具有相应权限
RBAC_QUERY_KEY='md'
